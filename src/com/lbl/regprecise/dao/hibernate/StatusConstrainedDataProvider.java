...
*/
	...
	public List<RegulogRegulatorDTO> getRegulogRegulatorsDTO(TFFamily tfFamily)
	{
		...
		return session.createSQLQuery(sql)		
			.addScalar("aaSequence", Hibernate.TEXT)
			.addScalar("regulatorId", Hibernate.INTEGER)
			.addScalar("regulatorVimssId", Hibernate.INTEGER)
			.addScalar("regulonId", Hibernate.INTEGER)
			.addScalar("regulogId", Hibernate.INTEGER)
			.addScalar("regulatorLocusTag", Hibernate.STRING)
			.addScalar("regulatorName", Hibernate.STRING)
			.addScalar("regulonSiteCount", Hibernate.BIG_INTEGER)
			.addScalar("genomeName", Hibernate.STRING)
			.addScalar("taxonId", Hibernate.INTEGER)

			.addScalar("taxonName", Hibernate.STRING)
			.addScalar("phylum", Hibernate.STRING)
			.addScalar("pathway", Hibernate.STRING)
			.addScalar("effector", Hibernate.STRING)
